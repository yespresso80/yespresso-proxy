  ...
  if (req.url === '/bilancio-analizza' && req.method === 'POST') {
    ...
    try {
      ...
      const prompt = 'Analizza questo PDF che contiene una situazione contabile progressiva (da inizio anno a fine mese indicato) di una societa. Estrai tutti i dati in JSON strutturato. Rispondi SOLO con JSON valido, nessun testo aggiuntivo, nessun backtick.\n\n'
        ...
        + '- VOCI CRITICHE CHE DEVI ESTRARRE OBBLIGATORIAMENTE se presenti nel PDF:\n'
        + '  * "Fornitori" nel PASSIVO (aggregato di debiti v/fornitori generici, senza codice sottostante, importo tipicamente centinaia di migliaia di euro): OBBLIGATORIO estrarlo\n'
        + '  * "Altri debiti v/fornitori" (aggrega codici 26xxx come Fatture da ricevere)\n'
        + '  * "Fornitori" nell ATTIVO (aggregato di anticipi/note credito senza codice sottostante): se presente\n'
        + '  * "Clienti" nell ATTIVO (aggregato senza codice sottostante): se presente\n'
        + '- Esempio concreto: nel PDF passivo vedi una riga "Fornitori  547.492,21" SENZA codice conto: questa e un subtotale. Se non la estrai, il bilancio non quadra.\n'
        ...
        + '- Verifica finale: la SOMMA dei subtotali di sezione passivo + utile d esercizio a pareggio deve essere uguale a totale_passivo del PDF.\n\n'
        + 'ALTRI CAMPI:\n'
