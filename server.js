  ...
  if (req.url === '/bilancio-analizza' && req.method === 'POST') {
    ...
    try {
      ...
      const prompt = 'Analizza questo PDF che contiene una situazione contabile progressiva (da inizio anno a fine mese indicato) di una societa. Estrai tutti i dati in JSON strutturato. Rispondi SOLO con JSON valido, nessun testo aggiuntivo, nessun backtick.\n\n'
        ...
        + 'REGOLE PER SUBTOTALI (IMPORTANTE):\n'
        + '- Nel PDF ci sono alcune righe-intestazione che NON hanno codice conto ma rappresentano SUBTOTALI di sezione. Esempio tipico: una riga "Fornitori 547.492,21" seguita dal dettaglio "Altri debiti v/fornitori 82.464,28 / 26010.1 Fatture da ricevere 82.464,28".\n'
        + '- Questi subtotali vanno messi nell array "subtotali" con descrizione (es. "Fornitori"), importo, e sezione.\n'
        + '- ATTENZIONE: non duplicare i valori. Se una riga ha codice conto (es. 26010.1), va in "conti". Se NON ha codice e e un aggregato di altre righe sottostanti, va in "subtotali".\n'
        + '- Esempi di subtotali passivi tipici: "Fornitori", "Patrimonio netto", "Fondo TFR", "Fondi ammortamento immobilizzazioni immateriali", "Fondi ammortamento immobilizzazioni materiali", "Debiti tributari", "Debiti diversi", "Altri debiti v/fornitori".\n'
        + '- Esempi di subtotali attivi: "Immobilizzazioni", "Immobilizzazioni immateriali", "Immobilizzazioni materiali", "Attivo circolante", "Rimanenze", "Clienti", "Crediti tributari", "Crediti diversi", "Fornitori" (se in attivo, es. anticipi), "Attivita finanziarie non immobilizzate", "Disponibilita liquide", "Ratei e risconti attivi".\n\n'
        + 'ALTRI CAMPI:\n'
