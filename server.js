  ...
  if (req.url === '/bilancio-analizza' && req.method === 'POST') {
    ...
    try {
      ...
      const prompt = 'Analizza questo PDF che contiene una situazione contabile progressiva (da inizio anno a fine mese indicato) di una societa. Estrai tutti i dati in JSON strutturato. Rispondi SOLO con JSON valido, nessun testo aggiuntivo, nessun backtick.\n\n'
        ...
        + '  ],\n'
        + '  "subtotali": [\n'
        + '    {"descrizione":"Fornitori","importo":474360.36,"sezione":"passivo"},\n'
        + '    {"descrizione":"Immobilizzazioni immateriali","importo":33081.59,"sezione":"attivo"}\n'
        + '  ],\n'
        + '  "totali": {\n'
        ...
        + '  }\n'
        + '}\n\n'
        + 'REGOLE PER ESTRAZIONE CONTI:\n'
        + '- Includi TUTTI i conti CON CODICE presenti nel PDF, non saltare nessuna riga.\n'
        + '- Un conto con codice ha sempre formato tipo "12345.1" o "27340.1" (numero puntato).\n'
        + '- "sezione" deve essere una di: "attivo", "passivo", "costi", "ricavi".\n'
        + '- Usa la prima cifra del codice: 1x=attivo, 2x=passivo, 3x=costi, 4x=ricavi.\n'
        ...
        + 'REGOLE PER SUBTOTALI (CRITICO):\n'
        + '- Nel PDF ci sono righe-intestazione SENZA codice conto che rappresentano SUBTOTALI di sezione.\n'
        + '- VOCI CRITICHE CHE DEVI ESTRARRE OBBLIGATORIAMENTE se presenti nel PDF, ognuna come ENTRATA SEPARATA nell array "subtotali":\n'
        + '  * PASSIVO: "Fornitori" (debiti v/fornitori generici senza codice sottostante, centinaia di migliaia di euro)\n'
        + '  * PASSIVO: "Altri debiti v/fornitori" (aggrega codici 26xxx come Fatture da ricevere)\n'
        + '  * ATTIVO: "Clienti" (aggregato senza codice sottostante, tipicamente poche migliaia di euro, es. 4.270,00 o 9.231,33)\n'
        + '  * ATTIVO: "Fornitori" (aggregato di anticipi/note credito verso fornitori, SENZA codice sottostante, tipicamente decine di migliaia di euro, es. 39.280,81 o 59.758,76)\n'
        + '- REGOLA FONDAMENTALE: NON SOMMARE MAI due subtotali in uno. Se nel PDF vedi DUE righe separate "Clienti 4.270,00" e "Fornitori 39.936,47" devi produrre DUE entry separate nell array "subtotali", non UNA con 44.206,47.\n'
        + '- REGOLA FONDAMENTALE: "Clienti" e "Fornitori" sono DUE voci DISTINTE quando entrambe presenti nell attivo. La prima e crediti verso clienti, la seconda e anticipi/note credito verso fornitori. MAI confonderle o fonderle.\n'
        + '- Esempio concreto (frammento PDF attivo): "Crediti diversi 42.879,81 / 17110.1 Note di credito da ricevere 1.063,51 / ... / Fornitori 39.280,81 / Attivita finanziarie non immobilizzate 104,95" — qui "Fornitori 39.280,81" e un subtotale SENZA codice, da estrarre come entry separata.\n'
        + '- Esempio concreto (frammento PDF passivo): "Fornitori 547.492,21 / Altri debiti v/fornitori 82.464,28 / 26010.1 Fatture da ricevere 82.464,28" — qui "Fornitori 547.492,21" e un subtotale SENZA codice, DIVERSO da "Altri debiti v/fornitori".\n'
        + '- Esempi di subtotali passivi tipici: "Fornitori", "Altri debiti v/fornitori", "Patrimonio netto", "Fondo TFR", "Fondi ammortamento immobilizzazioni immateriali", "Fondi ammortamento immobilizzazioni materiali", "Debiti tributari", "Debiti diversi".\n'
        + '- Esempi di subtotali attivi: "Immobilizzazioni", "Immobilizzazioni immateriali", "Immobilizzazioni materiali", "Attivo circolante", "Rimanenze", "Clienti", "Crediti tributari", "Crediti diversi", "Fornitori", "Attivita finanziarie non immobilizzate", "Disponibilita liquide", "Ratei e risconti attivi".\n'
        + '- ATTENZIONE: non duplicare. Se una riga ha codice conto (es. 26010.1), va in "conti". Se NON ha codice ed e un aggregato sopra le righe di dettaglio, va in "subtotali".\n\n'
        + 'ALTRI CAMPI:\n'
